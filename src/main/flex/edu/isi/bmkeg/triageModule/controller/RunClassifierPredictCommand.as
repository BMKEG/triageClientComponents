...
{	
	...
	public class RunClassifierPredictCommand extends Command
	{
		
		[Inject]
		public var event:RunClassifierPredictEvent;
		...
		override public function execute():void {
			...
			service.runClassifier(event.targetCorpusName, event.triageCorpusName);
